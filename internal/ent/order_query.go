...
func (_q *OrderQuery) QueryRestaurant() *RestaurantQuery {
...
func (_q *OrderQuery) QueryOrderItems() *OrderItemQuery {
...
func (_q *OrderQuery) WithRestaurant(opts ...func(*RestaurantQuery)) *OrderQuery {
	query := (&RestaurantClient{config: _q.config}).Query()
...
func (_q *OrderQuery) WithOrderItems(opts ...func(*OrderItemQuery)) *OrderQuery {
	query := (&OrderItemClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *OrderQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Order, error) {
	...
	if query := _q.withRestaurant; query != nil {
		if err := _q.loadRestaurant(ctx, query, nodes, nil,
			func(n *Order, e *Restaurant) { n.Edges.Restaurant = e }); err != nil {
			return nil, err
		}
	}
...
func (_q *OrderQuery) loadRestaurant(ctx context.Context, query *RestaurantQuery, nodes []*Order, init func(*Order), assign func(*Order, *Restaurant)) error {
...
func (_q *OrderQuery) loadOrderItems(ctx context.Context, query *OrderItemQuery, nodes []*Order, init func(*Order), assign func(*Order, *OrderItem)) error {
...
func (_q *OrderQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withRestaurant != nil {
			_spec.Node.AddColumnOnce(order.FieldRestaurantID)
		}
	}
