...
const (
	// Label holds the string label denoting the userauthprovider type in the database.
	Label = "user_auth_provider"
	...
	EdgeUser = "user"
	// Table holds the table name of the userauthprovider in the database.
	Table = "user_auth_providers"
	// UserTable is the table that holds the user relation/edge.
	UserTable = "user_auth_providers"
...
// Columns holds all SQL columns for userauthprovider fields.
var Columns = []string{
	FieldID,
	FieldUpdateTime,
	FieldUserID,
...
// OrderOption defines the ordering options for the UserAuthProvider queries.
